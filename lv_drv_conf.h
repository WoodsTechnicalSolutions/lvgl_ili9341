 ...
 * DELAY INTERFACE
 *********************/
#define LV_DRV_DELAY_INCLUDE <unistd.h>          /*Dummy include by default*/
 ...
 *  Common
 *------------*/
#define LV_DRV_DISP_INCLUDE        "io.h"
#define LV_DRV_DISP_CMD_DATA(val)  io_dc(val)         /*Set the command/data pin to 'val'*/
#define LV_DRV_DISP_RST(val)       io_reset(val)      /*Set the reset pin to 'val'*/

/*---------
 *  SPI
 *---------*/
#define LV_DRV_DISP_SPI_CS(val)          /*spi_cs_set(val)*/     /*Set the SPI's Chip select to 'val'*/
#define LV_DRV_DISP_SPI_WR_BYTE(data)    io_spi_write(data)         /*Write a byte the SPI bus*/
#define LV_DRV_DISP_SPI_WR_ARRAY(adr, n) io_spi_write_array(adr, n) /*Write 'n' bytes to SPI bus from 'adr'*/
